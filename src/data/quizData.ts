...
export const quizData: Quiz[] = [
    ...
    // い草の知識
    {
        ...
        correctIndex: 1,
        explanation: '{国産|こくさん}{畳表|たたみおもて}の{約|やく}9{割|わり}が{熊本県|くまもとけん}の{県南|けんなん}{地域|ちいき}（{八代市|やつしろし}・{氷川町|ひかわちょう}・{宇城市|うきし}など）で{作|つく}られています。',
    },
    {
        id: 'knowledge_02',
        category: 'knowledge',
    ...
    },
    {
        id: 'knowledge_04',
        category: 'knowledge',
        question: '{畳表|たたみおもて}1{枚|まい}に{使|つか}われる{い草|いぐさ}の{本数|ほんすう}の{目安|めやす}は？',
        options: ['{約|やく}1000〜2000{本|ぼん}', '{約|やく}4000〜7000{本|ぼん}', '{約|やく}10000〜15000{本|ぼん}', '{約|やく}20000{本|ぼん}{以上|いじょう}'],
        correctIndex: 1,
        explanation: '{畳表|たたみおもて}1{枚|まい}に{約|やく}4,000〜7,000{本|ぼん}の{い草|いぐさ}が{使|つか}われます。{密|みつ}に{織|お}り{込|こ}むほど{高品質|こうひんしつ}な{畳|たたみ}になります。',
    },
    {
        id: 'knowledge_05',
        category: 'knowledge',
